...
What this proves, when it passes:
  ...
  1. VBox UEFI fetches fleetboot-x64-uefi (our built chainload binary) from
...
def test_vbox_uefi_pxe_boots_kernel_and_reporter_calls_home():
    ...
    tftpjail = TftpJailServer(
        ...
        # Lets UEFI PXE fetch fleetboot-x64-uefi without registry auth.
